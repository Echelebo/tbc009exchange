                    ...
                    <li class="dropdown-header d-flex justify-content-center text-start">
                        ...
                        <div class="profile-content">
                            ...
                            <span>{{auth()->user()->email}}</span>
                             <p align="center" class="mt-4" style="background-color: #b59245; padding: 4px; border-radius: 15px;"><strong><font size="4">{{ auth()->user()->account_level }} User </font> @if (auth()->user()->tagged_account_level != NULL) <font color="green" size="2"> -  {{ auth()->user()->tagged_account_level }}  </font> @else @endif</strong></p>
