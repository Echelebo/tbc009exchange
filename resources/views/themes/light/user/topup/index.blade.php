                            ...
                            <div class="card-body">
                               ...
                               <div class=" share_link d-flex align-items-center mt-4">
                                <label id="usdttrc20">USDT TRC-20</label>
                                    <input type="text" class="input form-control border-0" style="color: #ffffff; width: 50%;" id="usdttrc20" value="" readonly="">
                                ...
                                <div class=" share_link d-flex align-items-center mt-4">
                                    ...
                                    <input type="text" class="input form-control border-0" style="color: #ffffff; width: 50%;" id="usdterc20" value="" readonly="">
                                ...
                                <div class=" share_link d-flex align-items-center mt-4">
                                    ...
                                    <input type="text" class="input form-control border-0" style="color: #ffffff; width: 50%;" id="usdtbep20" value="" readonly="">
