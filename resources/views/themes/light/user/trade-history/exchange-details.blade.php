        ...
        <div class="row">
            <div class="account-settings-profile-section">
                <div class="card">
                    ...
                    <i class="fa fa-info-circle mt-4" aria-hidden="true" style="color: #c1923f"></i><font color="#dc3543" style="">Hello, to complete your exchange, you have to stake USDT equivalent to the exchange amount.</font>
