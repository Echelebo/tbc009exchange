                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="checkout-section">
                        ...
                        <div class="alert-message mt-20">
                            ...
                            <span>@lang("Please wait for a moment. "){{basicControl()->site_title}} is actively processing your trade. You can copy your transaction ID and track the progress of your trade from this location. <a
